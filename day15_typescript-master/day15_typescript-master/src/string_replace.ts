...
*/
function replaceString(inputString, searchString, replaceWith) {
    ...
    const newString = inputString.replace(searchString,replaceWith);
    return newString;
}
console.log(replaceString("hello","ello","i"));